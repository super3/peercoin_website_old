				...
				<div class="panel-group" id="accordion">
				  ...
				  <div class="panel panel-default">
				    ...
				    <div id="collapseFive" class="panel-collapse collapse">
				      <div class="panel-body">
				        <p>&quot;Checkpoints are like an alert message, clients listen to them but do not enforce the checkpoint by default. Users have the choice to enable the enforcement of checkpoint, but it’s a conscious choice users must take. This means the developer responsible for the checkpoint must gain community consensus before using them, developer cannot arbitrarily force a block chain reorganization onto the users. Generally speaking the checkpoint feature should not be used without 51% attack emergency.
						<br/><br/>
