    ...
    <div class="container content">
      <div class="row">
        ...
        <div class="item col-md-6">
          ...
          <ul style="list-style-type: circle;">
            <li>
              <a href="https://www.youtube.com/watch?v=TjL2AgCQDJ0">What is Peercoin?</a> -  YouTube Introduction into Peercoin; What makes it different from BTC?
            </li>
            <li>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="item col-md-6">
            <h2 name="""retail"> Shops, Products and Services accepting Peercoin</h2>
            <p>
              <strong>Use your peercoins to purchase and trade and make Peercoin commonly used world wide</strong>
            </p>
            <p>
