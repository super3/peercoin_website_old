	...
	<div class="row sinfo">
		<div class="col-lg-4 col-lg-offset-1">
			<p>
				...
				investors choice, and are able to earmark certain projects that fit both their intrests and the interests of the
...
<div class="container">
	<div class="row centered">
		...
		<div class="col-lg-8 col-lg-offset-2">
			...
			<p class="lead">
				Recommended sponsorship for most Peercoin accepting businesses and services. May be gifted by the community.
			</p>
		</div><!-- col-lg-8 -->
		<br>
