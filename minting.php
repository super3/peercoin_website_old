					...
					<div id="collapseTwo" class="panel-collapse collapse">
						<div class="item">
							<div class="col-lg-12">
								...
								We'll use the QT version of peercoin: ppcoin-qt. Navigate to the /usr/bin folder and execute the ppcoin-qt binary. These will set-up the required folders. Encrypt the wallet and write down the passphrase. Don't lose it!
